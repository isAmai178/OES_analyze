...
class OESController:
    ...
    def execute_OES_analysis(self, folder_path, save_folder_path, base_name, wavebands, thresholds, skip_range_nm, filter_enabled, intensity_threshold):
            try:
